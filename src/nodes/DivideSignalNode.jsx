// src/nodes/DivideSignalNode.jsx
import React from "react";
import { Handle, Position } from "reactflow";

import HorizontalRuleIcon from "@mui/icons-material/HorizontalRule";

export default function DivideSignalNode({ id, data, type }) {
  const label = data?.signalName || `Sum of Signals`;
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 8 }}>
        ...
        >
          <HorizontalRuleIcon style={{ fontSize: 20, color: "#0f1724", opacity: 0.9 }} />
        </div>
